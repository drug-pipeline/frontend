...
import ModuleSidebar, { MODULES, ModuleSpec } from "@/app/components/pipeline2/Modules";
import { nodeTypes, type NodeData } from "@/app/components/pipeline2/NodeCard";
import Modal from "@/app/components/pipeline2/Modal";
import NodeDetailDock, { type MinimalNodeDTO } from "@/app/components/pipeline2/NodeDetailDock";
            ...
            <div className="grid grid-cols-[300px_1fr]">
                ...
                <main className="relative">
                    ...
                    <NodeDetailDock
                        ...
                        onRefreshLogs={() => { if (selectedNodeId) loadNodeLogs(selectedNodeId); }}
                        logs={logs}
                        refreshingLogs={refreshingLogs}
                        onReloadDetail={() => { if (selectedNodeId) reloadDetail(selectedNodeId); }}
